...
if __name__ == "__main__":
    ...
    # Only process a subset of sequences.

    data_srcs = ["ArgoVerse", "BDD", "Charades", "LaSOT", "YFCC100M"]
    if args.datasrc:
        data_srcs = args.datasrc

    with open("../datasets/tao/tao_val_subset_small.txt", 'r') as f:
        content = f.readlines()
    ...
    for datasrc in data_srcs:
        ...
        video_names = [line.split('/')[-1][:-1] for line in content if line.split('/')[0] == datasrc]
